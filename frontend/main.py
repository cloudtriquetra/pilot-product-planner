        ...
        if not current_reports and not versioned_reports:
            ...
            if selected_report_name:
                ...
                try:
                    ...
                    if selected_md_file == "ra-business-case.md":
                        st.markdown("---")
                        ...
                        if os.path.exists(csv_path):
                            ...
                            with col1:
                                if st.button("📥 Generate & Download Excel", type="primary"):
                                    try:
                                        # Generate Excel file
                                        excel_filename = create_excel_from_csv(usecase_path, selected_usecase)
                                        ...
                                        if excel_filename and os.path.exists(excel_filename):
                                            ...
                                            download_filename = f"{selected_usecase}_business_case.xlsx"
                                            st.download_button(
